    ...
    <main className="max-w-4xl mx-auto px-4 py-16">
      ...
      <section className="mb-12 text-center">
        ...
        <p className={`${ts} text-sm md:text-base leading-relaxed max-w-3xl mx-auto mb-4`}>
          ...
          weather intelligence platform based in West Bengal, India.
        </p>

        {/* POWER INTRO — Paragraph 2 */}
        <p className={`${ts} text-sm md:text-base leading-relaxed max-w-3xl mx-auto mb-4`}>
          He is an Indian full-stack developer, quantum computing
        ...
        <div className="p-6 md:p-8 rounded-2xl bg-white/5 border border-white/10">
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <p className={`${ts} text-sm leading-relaxed`}>
              GameSaveSync is a cloud-based game save synchronization platform
              developed by Rick Das, allowing users to sync and manage game
              progress across multiple devices seamlessly.
            </p>
            <p className={`${ts} text-sm leading-relaxed mt-3`}>
              This is an upcoming, in-development project focused on reliable
              cross-device continuity, secure cloud backups, and smooth restore
              workflows for modern gaming experiences.
            </p>
          </div>
        </div>
      </section>
